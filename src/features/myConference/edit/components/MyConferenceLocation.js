...
const MyConferenceLocation = props => {
  ...
  return (
    <Grid item container lg={12} spacing={3}>
      ...
      <Grid item container lg={12} spacing={3}>
        <Grid item xs={12} sm={6} lg={3}>
          <CustomTextField label={t('Location.Latitude')} fullWidth isNumeric value={latitude} onChange={handleDispatch('latitude')} />
        </Grid>
        <Grid item xs={12} sm={6} lg={3}>
          <CustomTextField label={t('Location.Longitude')} isNumeric fullWidth value={longitude} onChange={handleDispatch('longitude')} />
        </Grid>
      </Grid>
    </Grid>
  )
